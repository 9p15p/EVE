...
class ChannelGate(nn.Module):
    ...
    def forward(self, x): # Use two pooling methods, sum them up to cal 'scale', then times 'x' by 'scale'
...
class ChannelPool(nn.Module):
    def forward(self, x): # adopt max and min on channels and cat them.
...
class CBAM(nn.Module):
    ...
    def forward(self, x):  # use ChannelGate and SpatialGate
