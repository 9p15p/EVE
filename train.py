...
# from model.trainer_lab import XMemTrainer
# from dataset.vos_dataset_lab import VOSDataset
from model.trainer import XMemTrainer
# from dataset.vos_dataset_flow import VOSDataset
...
for si, stage in enumerate(stages_to_perform):
    ...
    def renew_vos_loader(max_skip, finetune=False):
        ...
        davis_dataset = VOSDataset(
            ...
            subset=load_sub_davis(), num_frames=config['num_frames'], finetune=finetune)
        if config['close_ytb']:
